...
public class StrategyOptimizer {
    ...
    public RaceStrategy optimizeOneStop(Circuit circuit,
        ...
        stints.add(new Stint(bestC1, 1, bestPitLap));
        stints.add(new Stint(bestC2, bestPitLap + 1, totalLaps - bestPitLap));
