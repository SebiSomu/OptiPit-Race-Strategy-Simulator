 ...
 * Includes Fuel Burn effect, Track Evolution, and Non-linear Tyre Degradation
 * ("The Cliff").
 */
@Service
public class SimulationService {
    ...
    public double calculateLapTime(double baseLapTime,
        ...
        // Non-linear degradation (the "cliff"): degradation accelerates as the tyre
        // wears out.
        // Power of 1.8 ensures that after 20-30 laps, the tyre starts losing seconds,
        // not just decimals.
